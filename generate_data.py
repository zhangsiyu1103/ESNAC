...
model = models.GroundTruth2()
#model.load_state_dict(torch.load('ground_truth0.pth'))

torch.save(model.state_dict(), 'base/groundtruth2.pth')
...
torch.save(data, "datasets/data/sample/groundtruth3/train.pt")
...
torch.save(data, "datasets/data/sample/groundtruth3/test.pt")
