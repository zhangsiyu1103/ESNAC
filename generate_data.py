...
model = models.GroundTruth8()
model.load_state_dict(torch.load('base/groundtruth8.pth'))

#torch.save(model.state_dict(), 'base/groundtruth8.pth')
...
torch.save(data, "datasets/data/sample/groundtruth8/train.pt")
...
torch.save(data, "datasets/data/sample/groundtruth8/test.pt")
